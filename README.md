...
- The inner and outer ones differ at offset 64, neither being 0, so this seems to have some meaning (both both have 0x14 at 60)
...
- offset 8, 4-byte ints, in the approximate range 1000-3000
  ...
  - this offset changes when the equalizer is changed from "none" to something else, but it doesn't matter which equalizer is chosen; however, this pair of values isn't consistent between tracks
